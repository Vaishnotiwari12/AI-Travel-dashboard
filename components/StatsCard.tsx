    ...
    return (
        <article className="stats-card">
            ...
            <div className="content">
                ...
                <img src={`/assets/icons/${isDecrement ? 'decrement.svg' : 'increment.svg'} `} className="w-full h-auto max-w-full aspect-[1/1] sm:max-w-[128px] md:max-w-[160px] lg:max-w-[192px] xl:max-w-[256px]" alt="trend graph" />
            </div>
        </article>
    )
}
